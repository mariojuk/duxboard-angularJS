...
angular.module("templates/emoji-popover.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/emoji-popover.html",
    ...
    "      </div>\n" +
    "    <div class=\"emoji-container\" scrollbar>\n" +
...
angular.module('vkEmojiPicker').directive('emojiPicker', [
  'EmojiGroups', 'vkEmojiStorage', 'vkEmojiTransforms', function (emojiGroups, storage, vkEmojiTransforms) {
    ...
    var templateUrl = 'templates/emoji-button.html';
  ...
  this.$get = [
    ...
    function ($rootScope, $http, $sce, $templateCache, $compile) {
      function EmojiPopover(element, config) {
        ...
        scope.$on('openEmojiPicker', function() {  
            //console.log("YES");
            $popover.toggle();            
        });
        ...
        $popover.show = function () {
          ...
          popoverElement.addClass("ng-hide-remove");
